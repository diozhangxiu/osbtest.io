...
@section('title')
    Club Cempaka Putih Schedule | Osbondgym
@endsection
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="tagline-message page-title text-center">
                                ...
                                <ul class="breadcrumb">
                                    <li><a href="/">Home</a></li>
                                    <li class="active">Schedule Club Cempaka Putih</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div class="tab-pane fade in active">
                                                <div class="row">
                                                    <div class="col-md-12" style="padding-top: 20px;">
                                                        <div class="tagline-message page-title text-center">
                                                            <h3>SCHEDULE CLUB CEMPAKA PUTIH</h3>
                                                            <h4>NOVEMBER 2021</h4>
                                                        </div>
                                                    </div>
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td>
                                                                                            <div class="box">
                                                                                                <div class="icon">
                                                                                                    <img src="images/schedule/x-fight.png" style="width: 80px;">
                                                                                                </div>
                                                                                                <h4>X-Fight</h4>
                                                                                        ...
                                                                                        <td>
                                                                                            <div class="box">
                                                                                                <div class="icon">
                                                                                                    <img src="images/schedule/x-strength.png" style="width: 80px;">
                                                                                                </div>
                                                                                                <h4>X-Strength</h4>
                                                                                                <p style="text-align: center;">Panca</p>
                                                                                                <span>20:00 WIB</span>
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td>
                                                                                            <div class="box">
                                                                                                <div class="icon">
                                                                                                    <img src="images/schedule/pilates.png" style="width: 80px;">
                                                                                                </div>
                                                                                                <h4>Pilates</h4>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <div class="box">
                                                                                                ...
                                                                                                <h4>X-Fight</h4>
                                                                                                <p style="text-align: center;">Wency</p>
                                                                                                <span>20:00 WIB</span>
                                                                                            </div>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <div class="box">
                                                                                                ...
                                                                                                <h4>Zumba</h4>
                                                                                                <p style="text-align: center;">Ifah</p>
                                                                                                <span>19:00 WIB</span>
                                                                                            </div>
                                                                                        ...
                                                                                        <td>
                                                                                            <div class="box">
                                                                                                <div class="icon">
                                                                                                    <img src="images/schedule/salsation.png" style="width: 80px;">
                                                                                                </div>
                                                                                                <h4>Salsation</h4>
                                                                                                <p style="text-align: center;">Sari</p>
                                                                                                <span>20:00 WIB</span>
                                                                                            </div>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td>
                                                                                            <div class="box">
                                                                                                ...
                                                                                                <h4>Zumba</h4>
                                                                                                <p style="text-align: center;">Maryani</p>
                                                                                                <span>16:00 WIB</span>
                                                                                            </div>
