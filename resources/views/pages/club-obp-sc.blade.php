...
@section('title')
    Club One Bellpark Schedule | Osbondgym
@endsection
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="tagline-message page-title text-center">
                                ...
                                <ul class="breadcrumb">
                                    <li><a href="/">Home</a></li>
                                    <li class="active">Schedule Club One Bellpark</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div class="tab-pane fade in active">
                                                <div class="row">
                                                    <div class="col-md-12" style="padding-top: 20px;">
                                                        <div class="tagline-message page-title text-center">
                                                            <h3>SCHEDULE CLUB ONE BELLPARK</h3>
                                                            <h4>NOVEMBER 2021</h4>
                                                        </div>
                                                    </div>
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td>
                                                                                            <div class="box" >
                                                                                                <div class="icon">
                                                                                                    <img src="images/schedule/basic-yoga.png" style="width: 80px;">
                                                                                                </div>
                                                                                                <h4>Basic Yoga</h4>
                                                                                        ...
                                                                                        <td>
                                                                                            <div class="box" >
                                                                                                ...
                                                                                                <h4>Zumba</h4>
                                                                                                <p style="text-align: center;">Dshee</p>
                                                                                                <span>18.30 WIB</span>
                                                                                            </div>
                                                                                        </td>
                                                                                        <td>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td>
                                                                                            <div class="box">
                                                                                                ...
                                                                                                <h4>Hatha Yoga</h4>
                                                                                                <p style="text-align: center;">Arif</p>
                                                                                                <span>17:30 WIB</span>
                                                                                            </div>
                                                                                        </td>
                                                                                        <td>
